...
final class LinkControllerTest extends WebTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        foreach ($this->linkRepository->findAll() as $object) {
    ...
    public function testNew(): void
    {
        ...
        self::assertSame(1, $this->linkRepository->count([]));
    }
    ...
    public function testEdit(): void
    {
        ...
        $fixture = $this->linkRepository->findAll();
    ...
    public function testRemove(): void
    {
        ...
        self::assertResponseRedirects('/link/');
        self::assertSame(0, $this->linkRepository->count([]));
    }
}
